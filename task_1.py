...
class ToDo:
    def __init__(self, root):
        ...
        self.label = Label(self.root, text="To-Do-List", font="Ariel, 25 bold", width=10, bd=5, bg="orange", fg="black")
        self.label.pack()  
        
        self.label2 = Label(self.root, text="Add Task", font="Arial, 18 bold", width=10, bd=5, bg="orange", fg="black")
        self.label2.place(x= 40,y=54)

        self.label3 = Label(self.root, text="Taks", font="Arial, 18 bold", width=10, bd=5, bg="orange", fg="black")
